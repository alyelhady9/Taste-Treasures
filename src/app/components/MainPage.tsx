...
// function MainPage() {
//   return (
//     // This top-level container now has overflow-x-hidden to prevent horizontal scrolling
//     <div className="flex flex-col pr-0 w-full select-none text-gray-700 overflow-x-hidden">
//       {/* Hero Section */}
//       <div className="relative w-full min-h-screen overflow-hidden">
//         {/* Background with subtle parallax and gradient overlay */}
//         <div className="absolute inset-0 z-0">
//           <Image
//             fill
//             className="object-cover overflow-hidden transition-transform duration-[20s] ease-out hover:scale-100"
//             // Using a slightly more subtle scale to prevent overflow
//             style={{ transform: 'scale(1.05)' }}
//             src={bg}
//             alt="Culinary Background"
//             priority
//           />
//           <div className="absolute inset-0 bg-gradient-to-br from-red-600/30 via-orange-500/30 to-yellow-400/30" />
//         </div>
...
//             <h1 className="text-5xl md:text-6xl lg:text-8xl font-extrabold mb-12 text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-red-600 animate-pulse drop-shadow-2xl">
//               Find, Cook, Enjoy!
//             </h1>
...
//                 <button className="relative group overflow-hidden bg-gradient-to-r from-red-500 to-orange-600 hover:from-red-600 hover:to-orange-700 text-white font-bold py-3 px-8 rounded-full transition-all duration-300 transform hover:scale-105 shadow-xl hover:shadow-2xl hover:shadow-red-500/50">
...
//               <button className="relative group bg-white/10 backdrop-blur-md border-2 border-white/30 text-white hover:text-white font-bold py-3 px-8 rounded-full transition-all duration-300 transform hover:scale-105 hover:bg-white/20">
