...
//         <div className="w-8/12 mx-auto max-md:w-10/12 text-gray-700">
...
//             Extensive Recipe Collection: Discover thousands of recipes from various cuisines, each carefully curated and tested by our team of culinary experts. From quick weeknight dinners to elaborate holiday feasts, we have something for every occasion.
//             User-Friendly Search: Our intuitive search and filter options make it easy to find the perfect recipe. Search by ingredients, cuisine, dietary preferences, and more to tailor your cooking experience to your needs.
//             Step-by-Step Instructions: Each recipe comes with detailed, step-by-step instructions and photos to guide you through the cooking process. Whether you’re a beginner or an experienced cook, you’ll find our recipes easy to follow.
//             Community Engagement: Join our community of food enthusiasts! Share your own recipes, leave reviews, and connect with other members. Our forums and comment sections are great places to exchange tips, ask questions, and find inspiration.
//             Personalized Experience: Create a free account to save your favorite recipes, create shopping lists, and receive personalized recommendations based on your preferences and cooking history.
//             </p>
//         </div>
//         <div className="my-4">
//             <h3 className="text-xl text-amber-500 font-bold mb-2">
...
//                     <p className="my-2">
//                     <span className="text-green-500"> Quality:  </span>  We are committed to providing high-quality, reliable recipes that you can trust. Our team rigorously tests each recipe to ensure it meets our standards of excellence.
                        
//                     </p>
                
//                     <p className="my-2">
//                     <span className="text-green-500">Diversity: </span> We celebrate the rich diversity of global cuisines and strive to include recipes from all corners of the world. Our goal is to make it easy for you to explore new flavors and cooking techniques.

//                     </p>
                
//                     <p className="my-2">
//                     <span className="text-green-500">Community: </span> We believe that food brings people together. Our platform is built on the idea of sharing and connecting through the love of cooking. We encourage our users to engage, share their experiences, and support one another.

//                     </p>
                
//                     <p className="my-2">

//                     <span className="text-green-500">Innovation: </span> We are constantly evolving to bring you the best possible experience. From new features to the latest culinary trends, we are dedicated to staying at the forefront of food and technology.
//                     </p>
//             </div>
//         </div>
...
//             We invite you to explore Taste Treasures and embark on a culinary adventure with us. Whether you’re looking to try a new recipe, improve your cooking skills, or simply find inspiration, we are here to support you every step of the way.

//             Thank you for being a part of our community. <span className="text-green-500 text-lg"> Happy cooking!</span>
